		...
		<main className="container mx-auto px-4 py-12">
			...
			<div className="max-w-5xl mx-auto">
				<RelatedArticles
					...
					cta={bookingCta}
					// The owner's own wording (Settings > Business > booking box) beats
					// the dictionary default; `bookingCta` is null when they turned it off.
					ctaLabel={bookingCta?.buttonLabel ?? dict['blog.cta.book.call']}
					ctaDescription={bookingCta?.lead ?? dict['blog.cta.book.call.description']}
				/>
			</div>
		</main>
	)

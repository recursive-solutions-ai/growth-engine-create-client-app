...
const fr: Dictionary = {
	...
	// Hero
	'hero.title': 'Bienvenue chez {{CLIENT_NAME}}',
	...
	'blog.filed.under': 'Classé sous',
	'blog.topic.title': '{topic}',
	'blog.topic.subtitle': '{count} articles sur {topic}',
	'blog.cta.book.call': 'Réserver un appel découverte gratuit de 15 minutes',
	'blog.cta.book.call.description':
		'Vous ne savez pas ce qui s’applique à votre situation ? Parlons-en ensemble.',
	...
	'footer.copyright': '\u00A9 {year} {{CLIENT_NAME}}. Tous droits r\u00E9serv\u00E9s.',
	...
	'newsletter.unsubscribe.heading': 'Se désabonner',
	'newsletter.unsubscribe.subtitle':
		'Saisissez l’adresse e-mail à retirer de notre newsletter.',
	'newsletter.unsubscribe.button': 'Se désabonner',
	'newsletter.unsubscribe.success':
		'Si cette adresse figurait dans notre liste, elle en a été retirée.',
	'newsletter.unsubscribe.successHint':
		'Un e-mail déjà en cours d’envoi peut mettre quelques minutes à s’arrêter.',

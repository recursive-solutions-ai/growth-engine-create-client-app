const en = {
	...
	'blog.cta.book.call': 'Book a free 15-minute discovery call',
	'blog.cta.book.call.description': 'Not sure what applies to your situation? Talk it through with us.',
	...
	'newsletter.unsubscribe.heading': 'Unsubscribe',
	'newsletter.unsubscribe.subtitle':
		'Enter the email address you want removed from our newsletter.',
	'newsletter.unsubscribe.button': 'Unsubscribe',
	// Neutral on purpose: it must read the same whether or not the address was
	// on the list, so the page cannot be used to check who subscribes.
	'newsletter.unsubscribe.success': 'If that address was on our list, it has been removed.',
	'newsletter.unsubscribe.successHint':
		'It can take a few minutes for an email already on its way to stop.',
